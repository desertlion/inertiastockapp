<template>
  <div>
    ...
    <div v-if="($page.error || Object.keys($page.errors).length > 0) && show" class="mb-8 flex items-center justify-between bg-red-500 rounded max-w-3xl">
      <div class="flex items-center">
        ...
        <div v-if="$page.error" class="py-4 text-white text-sm font-medium">{{ $page.error }}</div>
